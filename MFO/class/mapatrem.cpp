...
MapaTrem::MapaTrem()
{
    ...
    fundoG1 = imread("img/mapa1.png", cv::IMREAD_COLOR);   // Read the file
    fundoG0 = imread("img/mapa2.png", cv::IMREAD_COLOR);   // Read the file
    trem1 = imread("img/train1.png", cv::IMREAD_COLOR);
    trem2 = imread("img/train2.png", cv::IMREAD_COLOR);
